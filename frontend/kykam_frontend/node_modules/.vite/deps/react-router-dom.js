...
import { t as require_react } from "./react-DvtWdLBm.js";
import { t as require_react_dom } from "./react-dom-BeATd9ik.js";
...
function RouterProvider({ router: router$1, flushSync: reactDomFlushSyncImpl, onError, unstable_useTransitions }) {
	...
	import_react.useLayoutEffect(() => {
		if (!initialized && router$1.state.initialized) setState(router$1.state, {
			deletedFetchers: [],
			flushSync: false,
			newErrors: null
		});
